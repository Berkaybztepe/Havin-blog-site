...
export const STICKERS = [
  { id: 'fiyonk', label: 'bow', svg: svg(100, 70, `
  ...
  { id: 'kalp', label: 'heart', svg: svg(100, 92, `
  ...
  { id: 'yildiz', label: 'star', svg: svg(100, 96, `
  ...
  { id: 'parilti', label: 'sparkle', svg: svg(100, 100, `
  ...
  { id: 'kelebek', label: 'butterfly', svg: svg(100, 84, `
  ...
  { id: 'kiraz', label: 'cherries', svg: svg(100, 100, `
    <g>
  ...
  { id: 'cicek', label: 'daisy', svg: svg(100, 100, `
  ...
  { id: 'gul', label: 'rose', svg: svg(100, 100, `
  ...
  { id: 'ay', label: 'moon', svg: svg(100, 100, `
  ...
  { id: 'bulut', label: 'cloud', svg: svg(120, 70, `
  ...
  { id: 'disko', label: 'disco ball', svg: svg(100, 100, `
  ...
  { id: 'melek', label: 'angel wings', svg: svg(120, 80, `
  ...
  { id: 'bant', label: 'washi tape', svg: svg(140, 46, `
  ...
  { id: 'bant2', label: 'tape · blue', svg: svg(140, 46, `
  ...
  { id: 'dantel', label: 'lace trim', svg: svg(140, 40, `
  ...
  { id: 'kupa', label: 'coffee', svg: svg(100, 88, `
  ...
  { id: 'kaset', label: 'cassette', svg: svg(120, 80, `
  ...
  { id: 'mektup', label: 'letter', svg: svg(120, 84, `
